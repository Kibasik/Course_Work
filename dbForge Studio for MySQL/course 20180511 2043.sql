...
-- Дата скрипта: 11.05.2018 20:43:40
...
--
-- Удалить представление `categorygoodsquantity`
--
DROP VIEW IF EXISTS categorygoodsquantity CASCADE;
...
--
-- Создать представление `categorygoodsquantity`
--
CREATE
DEFINER = 'root'@'localhost'
VIEW categorygoodsquantity
AS
SELECT
  `categorygoods`.`CategoryGoodsName` AS `CategoryGoodsName`,
